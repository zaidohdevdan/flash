...
export const SuccessView: React.FC<SuccessViewProps> = ({ onBack }) => {
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-[var(--bg-primary)] p-6 text-center">
            ...
            <h2 className="text-3xl font-black text-[var(--text-primary)] mb-2 tracking-tight uppercase">Relatório Enviado!</h2>
            <p className="text-[var(--text-tertiary)] mb-10 font-bold uppercase tracking-widest text-[10px]">O seu supervisor foi notificado em tempo real.</p>
