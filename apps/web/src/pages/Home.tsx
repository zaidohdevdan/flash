...
export function Home() {
    ...
    return (
        <div className="min-h-screen bg-white dark:bg-slate-950 font-sans text-slate-900 dark:text-slate-100 overflow-x-hidden selection:bg-lime-200 selection:text-lime-900 relative transition-colors duration-500">
            ...
            <nav className="fixed top-0 w-full z-50 bg-white/70 dark:bg-slate-950/70 backdrop-blur-2xl border-b border-white/20 dark:border-slate-800/50 shadow-[0_2px_20px_rgba(0,0,0,0.02)] transition-all">
                <div className="max-w-7xl mx-auto px-6 h-24 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-2xl font-black tracking-tighter text-slate-900 dark:text-white">FLASH<span className="text-[#a3b60b]">APP</span></span>
                    </div>

                    <div className="hidden md:flex items-center gap-10 text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-[0.15em]">
                ...
                <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16 relative z-10">
                    ...
                    >
                        <motion.div
                            ...
                            className="inline-flex items-center gap-3 px-5 py-2.5 bg-white dark:bg-slate-900 backdrop-blur-md rounded-full border border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-400 shadow-sm hover:shadow-md transition-shadow cursor-default group"
                        >
                            ...
                            <span className="text-[11px] font-black uppercase tracking-widest text-slate-500 dark:text-slate-500 group-hover:text-slate-900 dark:group-hover:text-slate-300 transition-colors">{t('home.hero.badge')}</span>
                        </motion.div>
                        ...
                        <motion.h1
                            ...
                            className="text-7xl lg:text-[6.5rem] font-black tracking-tighter leading-[0.9] text-slate-900 dark:text-white relative"
                        >
                        ...
                        <motion.p
                            ...
                            className="text-xl text-slate-500 dark:text-slate-400 max-w-xl leading-relaxed font-medium"
                        >
                    ...
                    >
                        ...
                        >
                            ...
                            <motion.div
                                ...
                                className="absolute top-[10%] right-4 md:right-[-40px] bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 p-4 md:p-5 rounded-[1.5rem] shadow-[0_20px_40px_-10px_rgba(0,0,0,0.1)] dark:shadow-[0_20px_40px_-10px_rgba(0,0,0,0.5)] flex items-center gap-4 md:gap-5 transform-style-3d translate-z-[80px]"
                            >
                            ...
                            <motion.div
                                style={{ z: zLayer3, opacity: opacityLayer3 }}
                                className="absolute bottom-[10%] left-4 md:left-[-40px] bg-slate-900 dark:bg-slate-800 backdrop-blur-md border border-slate-800 p-4 md:p-5 rounded-[1.5rem] shadow-[0_30px_60px_-15px_rgba(0,0,0,0.5)] flex items-center gap-4 md:gap-5 transform-style-3d translate-z-[120px]"
                            >
            ...
            <section id="features" className="py-40 relative z-10 bg-white dark:bg-slate-950 border-y border-slate-100 dark:border-slate-800/50">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="mb-24 text-center max-w-2xl mx-auto">
                        <h2 className="text-xs font-black text-slate-400 uppercase tracking-[0.4em] mb-6">{t('home.features.overline')}</h2>
                        <h3 className="text-5xl md:text-6xl font-black text-slate-900 dark:text-white tracking-tighter mb-6">
                            {t('home.features.title')} <br />{t('home.features.subtitle')}
                        </h3>
                    </div>
            ...
            {/* Developer Section */}
            <section id="about" className="py-24 md:py-40 bg-slate-100 dark:bg-slate-900 relative overflow-hidden">
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-24">
                        ...
                        >
                            <div className="p-8 md:p-12 bg-white dark:bg-slate-800 rounded-[3rem] border border-slate-200 dark:border-slate-700 shadow-2xl shadow-slate-200/50 dark:shadow-black/30 relative overflow-hidden group hover:shadow-[0_40px_80px_-20px_rgba(0,0,0,0.1)] transition-all duration-500">
                                ...
                                <h2 className="text-3xl md:text-5xl font-black mb-8 text-slate-900 dark:text-white tracking-tight relative z-10">{t('home.developer.name')}</h2>
                        ...
                        <div className="flex-1 space-y-10">
                            ...
                            <h3 className="text-5xl lg:text-7xl font-black tracking-tighter leading-[0.9] text-slate-900 dark:text-white">
                                {t('home.developer.manifesto.title')} <br />
            ...
            {/* Contact Section */}
            <section id="contact" className="py-40 px-6 bg-white dark:bg-slate-950 border-t border-slate-100 dark:border-slate-800">
                <div className="max-w-5xl mx-auto">
                    <div className="bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-[3.5rem] shadow-2xl shadow-slate-200/50 dark:shadow-black/50 p-10 md:p-20 relative overflow-hidden">
                        <div className="text-center mb-16 space-y-6">
                            <h2 className="text-xs font-black text-slate-400 uppercase tracking-[0.4em]">{t('home.contact.overline')}</h2>
                            <h3 className="text-5xl md:text-6xl font-black tracking-tighter text-slate-900 dark:text-white">
                                {t('home.contact.title')} <br /> {t('home.contact.subtitle')}
                            </h3>
                        </div>
